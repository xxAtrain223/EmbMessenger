    ...
    namespace shared
    {
        namespace test
        {
            TEST(reader_types, get_type_none)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0xD8));
            ...
            TEST(reader_types, get_type_null)
            {
                ...
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kNull)).WillOnce(Return(DataType::kBoolFalse));
            ...
            TEST(reader_types, get_type_uint_8)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint8)).WillOnce(Return(DataType::kUint16));
            ...
            TEST(reader_types, get_type_uint_16)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint16)).WillOnce(Return(DataType::kUint32));
            ...
            TEST(reader_types, get_type_uint_32)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint32)).WillOnce(Return(DataType::kUint64));
            ...
            TEST(reader_types, get_type_uint_64)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint64)).WillOnce(Return(DataType::kUint32));
            ...
            TEST(reader_types, get_type_int_8)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt8)).WillOnce(Return(DataType::kInt16));
            ...
            TEST(reader_types, get_type_int_16)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt16)).WillOnce(Return(DataType::kInt32));
            ...
            TEST(reader_types, get_type_int_32)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt32)).WillOnce(Return(DataType::kInt64));
            ...
            TEST(reader_types, get_type_int_64)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt64)).WillOnce(Return(DataType::kInt32));
            ...
            TEST(reader_types, get_type_posfixint)
            {
                ...
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0x00)).WillOnce(Return(0x41)).WillOnce(Return(0x7F));
            ...
            TEST(reader_types, get_type_negfixint)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0xE0)).WillOnce(Return(0xF0)).WillOnce(Return(0xFF));
            ...
            TEST(reader_types, get_type_float)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kFloat)).WillOnce(Return(DataType::kUint8));
            ...
            TEST(reader_types, next_char)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0x61)).WillOnce(Return(0x62)).WillOnce(Return(0xC0));
            ...
            TEST(reader_types, next_float)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillOnce(Return(false)).WillOnce(Return(false)).WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kFloat)).WillOnce(Return(DataType::kNull));
            ...
            TEST(reader_readers, read_bool_false)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kBoolFalse)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(DataType::kBoolFalse));
            ...
            TEST(reader_readers, read_uint8)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint8)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(DataType::kUint8)).WillOnce(Return(0xF1));
                EXPECT_CALL(buffer, size()).WillOnce(Return(2)).WillOnce(Return(1));
            ...
            TEST(reader_readers, read_uint16)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint16)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kUint16))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23));
                EXPECT_CALL(buffer, size()).WillOnce(Return(3)).WillOnce(Return(2));
            ...
            TEST(reader_readers, read_uint32)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint32)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kUint32))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23))
                ...
                EXPECT_CALL(buffer, size()).WillOnce(Return(5)).WillOnce(Return(4));
            ...
            TEST(reader_readers, read_uint64)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint64)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kUint64))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23))
                ...
                EXPECT_CALL(buffer, size()).WillOnce(Return(9)).WillOnce(Return(8));
            ...
            TEST(reader_readers, read_int8)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt8)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(DataType::kInt8)).WillOnce(Return(0xDF));
                EXPECT_CALL(buffer, size()).WillOnce(Return(2)).WillOnce(Return(1));
            ...
            TEST(reader_readers, read_int16)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt16)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kInt16))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23));
            ...
            TEST(reader_readers, read_int32)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt32)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kInt32))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23))
            ...
            TEST(reader_readers, read_int64)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt64)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kInt64))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23))
            ...
            TEST(reader_readers, read_posfixint_uint8)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0x0F)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(0x0F));
            ...
            TEST(reader_readers, read_negfixint_int8)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(false))
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0xF0)).WillOnce(Return(DataType::kNull));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(0xF0));
            ...
            TEST(reader_readers, read_null)
            {
                ...
                EXPECT_CALL(buffer, empty())
                    ...
                    .WillOnce(Return(true));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kNull)).WillOnce(Return(DataType::kBoolFalse));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(DataType::kNull));
            ...
            TEST(reader_expand, uint8_to_uint16)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint8)).WillOnce(Return(DataType::kUint8));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(DataType::kUint8)).WillOnce(Return(0xF1));
                EXPECT_CALL(buffer, size()).WillOnce(Return(2)).WillOnce(Return(1));
            ...
            TEST(reader_expand, uint16_to_uint32)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint16)).WillOnce(Return(DataType::kUint16));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kUint16))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23));
            ...
            TEST(reader_expand, uint32_to_uint64)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kUint32)).WillOnce(Return(DataType::kUint32));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kUint32))
                    .WillOnce(Return(0xF1))
                    .WillOnce(Return(0x23))
            ...
            TEST(reader_expand, int8_to_int16_pos)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(0x71)).WillOnce(Return(0x71));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(0x71));
            ...
            TEST(reader_expand, int16_to_int32_pos)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt16)).WillOnce(Return(DataType::kInt16));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kInt16))
            ...
            TEST(reader_expand, int32_to_int64_pos)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt32)).WillOnce(Return(DataType::kInt32));
                EXPECT_CALL(buffer, readByte())
                    .WillOnce(Return(DataType::kInt32))
                    .WillOnce(Return(0x71))
                    .WillOnce(Return(0x23))
            ...
            TEST(reader_expand, int8_to_int16_neg)
            {
                ...
                EXPECT_CALL(buffer, empty()).WillRepeatedly(Return(false));
                EXPECT_CALL(buffer, peek()).WillOnce(Return(DataType::kInt8)).WillOnce(Return(DataType::kInt8));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(DataType::kInt8)).WillOnce(Return(0x81));
                EXPECT_CALL(buffer, size()).WillOnce(Return(2)).WillOnce(Return(1));
            ...
            TEST(reader_expand, posfixint_to_uint64)
            {
                ...
                EXPECT_CALL(buffer, peek())
                    ...
                    .WillOnce(Return(0x41))
                    .WillOnce(Return(0x41));
                EXPECT_CALL(buffer, readByte()).WillOnce(Return(0x41));
